                ...
                <div class="col-6 grid__cell">
                    <div class="content__pr col__relative">
                        ...
                        <div class="form__inline--center button__sml">
                            <button data-tf-slider="Sgz7HGMv" data-tf-width="550" data-tf-hidden="utm_source=CTA,utm_medium=website,utm_campaign=velocityclub_site,utm_term=,utm_content=" class="btn btn--primary btn--md get_started_home_navbar_button" role="button">Book a session</button>
                        </div>
                    </div>
                </div>
            </div>
