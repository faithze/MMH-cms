            ...
            <div class="menu-control">
                <div class="branding">
                    <a href="${model.headerImageUrl_s}">
                        <img src="${model.headerImageSrc_s!""}" alt="${model.headerTitle_s!""}">
                    </a>
                </div>
            </div>
        </div>
        <div class="grid__cell col-6">
            <nav class="vc_navigation">
                <ul class="vc_global_nav">
                    ...
                    <li>
                        <button data-tf-slider="Sgz7HGMv" data-tf-width="550" data-tf-hidden="utm_source=CTA,utm_medium=website,utm_campaign=velocityclub_site,utm_term=,utm_content=" class="btn btn--primary" role="button">Book a session</button>
                    </li>
                </ul>
            </nav>
        </div>
